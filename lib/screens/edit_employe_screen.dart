...
class EditEmployeeScreen extends StatefulWidget {
  ...
  @override
  State<EditEmployeeScreen> createState() => _EditEmployeeState();
}
...
class _EditEmployeeState extends State<EditEmployeeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        actions: [
          IconButton(onPressed: (){editEmployee();}, icon:const Icon(Icons.save)),
          IconButton(onPressed: (){deleteEmployee();}, icon:const Icon(Icons.delete))
        ],
      ),
      body: Padding(
  ...
  void editEmployee(){
    ...
    if (isValid != null && isValid) {
      ...
      Provider.of<AppDb>(context,listen: false).updateEmployee(entity).then((value) => ScaffoldMessenger.of(context).showMaterialBanner(
        MaterialBanner(
  ...
  void deleteEmployee(){
    Provider.of<AppDb>(context,listen: false).deletEmployee(widget.id).then((value) => ScaffoldMessenger.of(context).showMaterialBanner(
          MaterialBanner(
              backgroundColor: Colors.pink,
